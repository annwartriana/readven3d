...
const mock = {
  ...
  profession: {
    M: [
      { id: 1, name: "chef", label: "Chef" },
      { id: 2, name: "scientist", label: "Científico" },
      { id: 3, name: "builder", label: "Constructor" },
      { id: 4, name: "doctor", label: "Doctor" },
      { id: 5, name: "nurse", label: "Enfermero" },
      { id: 6, name: "football", label: "Futbolista" },
      { id: 7, name: "engineer", label: "Ingeniero" },
      { id: 8, name: "business", label: "Negocios" },
      { id: 9, name: "teacher", label: "Profesor" },
      { id: 10, name: "worker", label: "Trabajador" },
      { id: 11, name: "veterinarian", label: "Veterinario" },
    ],
    W: [
      { id: 1, name: "chef", label: "Chef" },
      { id: 2, name: "scientist", label: "Científica" },
      { id: 3, name: "doctor", label: "Doctora" },
      { id: 4, name: "nurse", label: "Enfermera" },
      { id: 5, name: "engineer", label: "Ingeniera" },
      { id: 6, name: "business", label: "Negocios" },
      { id: 7, name: "teacher", label: "Profesor" },
      { id: 8, name: "veterinarian", label: "Veterinaria" },
    ],
  },
};
