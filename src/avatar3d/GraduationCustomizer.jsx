...
const mock = {
  ...
  outfits: {
    M: [
      { id: 1, name: "male_cyclist", label: "Ciclista" },
      { id: 2, name: "male_runner", label: "Corredor" },
      { id: 3, name: "male_explorer", label: "Explorador" },
      { id: 4, name: "male_futbol", label: "Futbolista" },
      { id: 5, name: "male_gym", label: "Gimnasio" },
      { id: 6, name: "male_motorcyclist", label: "Motociclista" },
      { id: 7, name: "male_graduate1", label: "Graduación versión 1" },
      { id: 8, name: "male_graduate2", label: "Graduación versión 2" },
    ],
    W: [
      { id: 1, name: "female_cyclist", label: "Ciclista" },
      { id: 2, name: "female_explorer", label: "Exploradora" },
      { id: 3, name: "female_karate", label: "Karate" },
      { id: 4, name: "female_motorcyclist", label: "Motociclista" },
      { id: 5, name: "female_skater", label: "Patinadora" },
      { id: 6, name: "female_exercise", label: "Running - Gimnasio" },
      { id: 7, name: "female_voleyball", label: "Volleyball" },
      { id: 8, name: "female_graduate1", label: "Graduación versión 1" },
      { id: 9, name: "female_graduate2", label: "Graduación versión 2" },
    ],
  },
};
