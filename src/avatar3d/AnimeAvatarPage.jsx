...
const mock = {
  ...
  outfits: {
    ...
    W: [
      { id: 1, name: "DBZ", label: "DBZ Goku" },
      { id: 2, name: "ezra_scarlet", label: "Fairy Tail Ezra Scarlet" },
      { id: 3, name: "lucy_heartfilia", label: "Fairy Tail Lucy Heartfilia" },
      { id: 4, name: "female_JJK", label: "Jujutsu Kaisen" },
      { id: 5, name: "kanao", label: "KNY Kanao" },
      { id: 6, name: "nezuko", label: "KNY Nezuko" },
      { id: 7, name: "shinobu", label: "KNY Shinobu" },
      { id: 8, name: "female_hogwarts", label: "Estudiante Hogwarts" },
      { id: 9, name: "female_mikasa", label: "Mikasa Ackerman" },
      { id: 10, name: "sailor_moon", label: "Sailor Moon" },
      { id: 11, name: "sakura_cardcaptor", label: "Sakura Cardcaptor" },
    ],
  },
};
